...
For ratio and lift contrasts, covariate grids, unit-level draws, and local slopes on continuous treatments, see [Predictions, Comparisons, and Slopes](predictions-comparisons-slopes.qmd) and the gallery notebooks [Conditional Predictions](../examples/06-interpret/predictions.qmd), [Interventional Contrasts](../examples/06-interpret/comparisons.qmd), and [Local Slopes](../examples/06-interpret/slopes.qmd).
