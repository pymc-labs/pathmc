...
For how pathmc compiles structural equations into a generative PyMC model — and the distinction between the causal DAG and the estimation graph — see the [architecture overview](01-how-it-works.qmd#from-structural-equations-to-the-generative-model).
