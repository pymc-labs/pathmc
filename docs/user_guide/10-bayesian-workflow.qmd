...
- [Custom Priors](../docs/examples/foundations/custom_priors.qmd) — deeper dive into prior specification with hierarchical priors and different distribution families
