...
See the [Panel Data Models](../docs/examples/panel_data.qmd), [Difference-in-Differences](../docs/examples/did.qmd), and [Media Mix Models](../docs/examples/mmm.qmd) examples for panel mode in action.
