...
See the [Panel Data Models](../examples/panel-time/panel_data.qmd), [Difference-in-Differences](../examples/panel-time/did.qmd), and [Media Mix Models](../examples/applied-models/mmm.qmd) examples for panel mode in action.
