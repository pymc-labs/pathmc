...
For `predictions()`, `comparisons()`, and `slopes()` on both `PathModel` and `AdjustmentModel`, see [Predictions, Comparisons, and Slopes](predictions-comparisons-slopes.qmd).
