...
Estimate channel-level ROI with adstock and saturation transforms that capture carry-over effects and diminishing returns. Panel mode handles geo-level data with hierarchical random effects. [Full example &rarr;](../examples/mmm.qmd)
...
- [Overview](01-how-it-works.qmd) — how pathmc works, from spec to causal insight
- [Bayesian workflow](10-bayesian-workflow.qmd) — the iterative cycle of inspect, check, refine, fit, and query
- [Model specification](11-model-specification.qmd) — DSL syntax: `~`, `~~`, `:=`, labels, transforms
- [Causal inference](13-causal-inference.qmd) — the do-operator, g-computation, identification
