...
See the [Cross-Sectional vs Panel DAGs](../examples/cross_sectional_vs_panel.qmd), [Difference-in-Differences](../examples/did.qmd), and [Media Mix Models](../examples/mmm.qmd) examples for panel mode in action.
