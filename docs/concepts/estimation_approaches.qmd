...
- You want pathmc's identification helpers ([`adjustment_sets()`](../how-it-works.qmd), [`collider_warnings()`](causal_inference.qmd)) to determine *what to adjust for*, then hand off to Bambi for estimation and g-computation
