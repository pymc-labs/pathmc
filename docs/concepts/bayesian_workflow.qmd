...
- [Custom Priors](../examples/custom_priors.qmd) — deeper dive into prior specification with hierarchical priors and different distribution families
- [Model Specification](model_specification.qmd) — DSL syntax reference
- [Causal Inference](causal_inference.qmd) — the do-operator and g-computation
- [Standardized Effects](standardized_effects.qmd) — comparing effect sizes across scales
