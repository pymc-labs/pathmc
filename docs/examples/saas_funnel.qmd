...
print("Effect of improving onboarding from 3 → 8:")
print(f"  ΔP(converted): {ate_onboarding.mean('converted'):.3f}")
print(f"  94% HDI:        {ate_onboarding.hdi('converted', prob=0.94)}")
```
