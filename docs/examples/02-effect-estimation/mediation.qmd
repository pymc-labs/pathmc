...
The [brand awareness example](../applied-models/mmm_awareness.qmd) demonstrates fully identified models using stochastic latent states and survey-augmented measurement equations.
