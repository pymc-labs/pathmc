...
print(f"ATE via do():      {ate_lin.mean():.3f}")
print(f"94% HDI:           {ate_lin.hdi(prob=0.94)}")
```
...
print(f"ATE via do() (risk difference):   {ate_log.mean():.3f}")
print(f"94% HDI:                          {ate_log.hdi(prob=0.94)}")
print(f"True ATE (risk difference):       {true_ate_logistic:.3f}")
```
...
print(f"ATE via do() (adjusted):      {ate_conf.mean():.3f}")
print(f"94% HDI:                      {ate_conf.hdi(prob=0.94)}")
