...
Always pair `do()` with careful thinking about your causal assumptions. See [Causal Identification](../identification/causal_identification.qmd) for how to verify that your model identifies the effect you want, including what to do when confounders are unobserved.
