...
print(f"ATE of X on Y:  {ate.mean():.3f}  (true = 0.4)")
...
print(f"ATE of X on Y:  {ate.mean():.3f}  (true = 0.6 × 0.5 = 0.3)")
print(f"94% HDI:        {ate.hdi(prob=0.94)}")
```
...
print(f"Biased ATE: {biased_ate.mean():.3f}")
print(f"94% HDI:    {biased_ate.hdi(prob=0.94)}")
```
...
print(f"Naive ATE:  {naive_ate.mean():.3f}  (true = {TRUE_INDIRECT:.1f})")
print(f"94% HDI:    {naive_ate.hdi(prob=0.94)}")
```
