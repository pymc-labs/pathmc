...
print(f"  Mean:    {brand_ate.mean():.3f}")
print(f"  94% HDI: {brand_ate.hdi(prob=0.94)}")
...
print(f"  Mean:    {ate_tv.mean():.3f}")
print(f"  94% HDI: {ate_tv.hdi(prob=0.94)}")
...
print(f"  Mean:    {ate_dig.mean():.3f}")
print(f"  94% HDI: {ate_dig.hdi(prob=0.94)}")
