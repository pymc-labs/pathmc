---
title: "Average Treatment Effects: Linear vs Logistic"
description: "Compare ATE estimation under linear and logistic models — why g-computation is the general solution."
...
This notebook demonstrates the difference with simulated data, verifies that pathmc's `do()` operator correctly recovers the ATE in both cases, and explains why g-computation is the general solution.
